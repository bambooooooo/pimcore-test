...
Przeniesienie wymiarów z ```objectbricks``` do ```classification store```
...
## [pim] [Product / ProductSet]

Eksporty:
- zdjęcia (plik .zip z oryginałami zdjęć)
...
Repozytorium dla pim. Branch'e: master, dev, feature/\*. Potok CI/CD, który wgra stabilną wersję na serwer produkcyjny.
Docker, PHP Storm. GitHub Actions
