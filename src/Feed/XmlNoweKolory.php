...
class XmlNoweKolory extends XmlFeedWriter
{
    public function __construct(Offer $offer, Offer $referenceOffer)
    {
        ...
        parent::__construct($data, function(Product|ProductSet $item) use ($offer, $referenceOffer) {
            ...
            $prod->appendChild($doc->createElement('name_en', (string)$item->getName("en")));
            ...
            $prod->appendChild($doc->createElement('price_bg', (string)number_format($priceBG, 2, ".", "")));
            $prod->appendChild($doc->createElement('price_hu', (string)number_format($priceHU, 2, ".", "")));
            $prod->appendChild($doc->createElement('price_ro', (string)number_format($priceRO, 2, ".", "")));
